...
module.exports = {
    ...
    wedding: {
        ...
        config: {
            ...
            content: {
                en: "<h2>Smart Wedding Budget Planner</h2><p>Avoid financial stress on your big day. Our 2026 wedding calculator breaks down your total budget into essential categories based on industry standards.</p><h3>Typical Alignments</h3><ul><li><strong>Venue & Catering (50%):</strong> The biggest expense. Includes food, drink, and rental.</li><li><strong>Photography (12%):</strong> Capturing the memories is usually the second priority.</li><li><strong>Buffer (10%):</strong> Always keep a safety margin for unexpected costs.</li></ul>",
                es: "<h2>Planificador de Presupuesto de Boda</h2><p>Evita el estrés financiero. Nuestra calculadora desglosa tu presupuesto total en categorías esenciales basadas en estándares de la industria.</p><h3>Asignaciones Típicas</h3><ul><li><strong>Lugar y Comida (50%):</strong> El gasto más grande.</li><li><strong>Fotografía (12%):</strong> Capturar los recuerdos es prioridad.</li><li><strong>Margen (10%):</strong> Mantén siempre un fondo de emergencia.</li></ul>",
                de: "<h2>Hochzeitsbudget-Planer</h2><p>Vermeiden Sie finanziellen Stress. Unser Rechner teilt Ihr Gesamtbudget basierend auf Industriestandards auf.</p><h3>Typische Verteilung</h3><ul><li><strong>Ort & Catering (50%):</strong> Der größte Kostenpunkt.</li><li><strong>Fotografie (12%):</strong> Erinnerungen sind wichtig.</li><li><strong>Puffer (10%):</strong> Planen Sie immer eine Reserve ein.</li></ul>",
                fr: "<h2>Planificateur de Budget Mariage</h2><p>Évitez le stress financier. Notre calculateur répartit votre budget total en catégories essentielles.</p><h3>Répartition Type</h3><ul><li><strong>Lieu & Traiteur (50%) :</strong> La plus grosse dépense.</li><li><strong>Photographie (12%) :</strong> Pour les souvenirs.</li><li><strong>Marge (10%) :</strong> Gardez toujours une sécurité.</li></ul>",
    ...
    solar: {
        ...
        config: {
            ...
            content: {
                en: "<h2>Calculate Your Solar Savings & ROI</h2><p>Switching to solar energy is one of the smartest investments for homeowners in 2026. With rising electricity rates, a solar panel system can pay for itself in 5-8 years.</p><h3>How This Calculator Works</h3><ul><li><strong>Sun Hours:</strong> We use local averages (e.g., 4-5 hours/day in the US) to estimate production.</li><li><strong>System Size:</strong> Calculated to offset 100% of your current bill.</li><li><strong>Incentives:</strong> Includes the 30% Federal Investment Tax Credit (ITC).</li></ul><p>Use this tool to verify quotes from installers and ensure you aren't oversold.</p>",
                es: "<h2>Calcula tu Ahorro con Energía Solar</h2><p>Cambiar a energía solar es una de las mejores inversiones en 2026. Con el aumento de las tarifas, un sistema solar puede pagarse solo en 5-8 años.</p><h3>Cómo Funciona</h3><ul><li><strong>Horas de Sol:</strong> Usamos promedios locales para estimar la producción.</li><li><strong>Tamaño del Sistema:</strong> Calculado para cubrir el 100% de tu factura.</li><li><strong>Incentivos:</strong> Incluye créditos fiscales estimados disponibles en tu región.</li></ul>",
                de: "<h2>Berechnen Sie Ihre Solareinsparungen</h2><p>Der Wechsel zu Solarenergie ist eine der klügsten Investitionen im Jahr 2026. Angesichts steigender Strompreise kann sich eine Anlage in 5-8 Jahren amortisieren.</p><h3>So funktioniert der Rechner</h3><ul><li><strong>Sonnenstunden:</strong> Wir nutzen lokale Durchschnitte.</li><li><strong>Anlagengröße:</strong> Berechnet, um 100% Ihrer Rechnung zu decken.</li><li><strong>Förderung:</strong> Berücksichtigt geschätzte staatliche Zuschüsse.</li></ul>",
                fr: "<h2>Calculez Vos Économies Solaires</h2><p>Passer au solaire est l'un des investissements les plus intelligents en 2026. Avec la hausse des tarifs, un système peut s'amortir en 5-8 ans.</p><h3>Fonctionnement</h3><ul><li><strong>Ensoleillement :</strong> Basé sur les moyennes locales.</li><li><strong>Taille du Système :</strong> Calculée pour couvrir 100% de votre facture.</li><li><strong>Aides :</strong> Inclut les estimations de crédits d'impôt et primes.</li></ul>",
    ...
    flooring: {
        ...
        config: {
            ...
            content: {
                en: "<h2>Flooring Cost Estimator</h2><p>Installing new flooring transforms a home, but costs vary wildly between materials. Our calculator provides a realistic estimate for 2026, including waste and labor.</p><h3>Key Cost Factors</h3><ul><li><strong>Material:</strong> Luxury Vinyl Plank ($3-5/sq ft) vs. Hardwood ($8-15/sq ft).</li><li><strong>Waste Factor:</strong> We add 10% standard waste for cuts (increase to 15-20% for diagonal patterns).</li><li><strong>Labor:</strong> Installation typically costs $2-5 per sq ft depending on complexity.</li></ul>",
                es: "<h2>Estimador de Costos de Suelos</h2><p>Instalar pisos nuevos transforma un hogar, pero los costos varían mucho. Nuestra calculadora ofrece una estimación realista para 2026.</p><h3>Factores Clave</h3><ul><li><strong>Material:</strong> Desde vinilo ($3-5/pie²) hasta madera dura ($8-15/pie²).</li><li><strong>Desperdicio:</strong> Agregamos un 10% estándar para cortes.</li><li><strong>Mano de Obra:</strong> La instalación varía según la complejidad.</li></ul>",
                de: "<h2>Bodenkosten-Schätzer</h2><p>Ein neuer Boden verändert einen Raum komplett. Unser Rechner liefert eine realistische Kostenschätzung für 2026 inklusive Verschnitt und Arbeit.</p><h3>Kostenfaktoren</h3><ul><li><strong>Material:</strong> Von Laminat bis Echtholzparkett.</li><li><strong>Verschnitt:</strong> Wir kalkulieren 10% Standard-Verschnitt ein.</li><li><strong>Arbeit:</strong> Verlegekosten variieren je nach Aufwand.</li></ul>",
                fr: "<h2>Estimateur de Coût de Revêtement de Sol</h2><p>Un nouveau sol transforme une maison. Notre calculateur fournit une estimation réaliste pour 2026, incluant les pertes et la main-d'œuvre.</p><h3>Facteurs Clés</h3><ul><li><strong>Matériau :</strong> Du vinyle au bois massif.</li><li><strong>Pertes :</strong> Nous ajoutons 10% pour les coupes.</li><li><strong>Main-d'œuvre :</strong> L'installation varie selon la complexité.</li></ul>",
    ...
    roofing: {
        ...
        config: {
            ...
            content: {
                en: "<h2>Roof Replacement Cost Calculator</h2><p>A new roof is a major expense. This tool helps you budget by estimating materials, labor, and disposal fees based on your roof's specific pitch and size.</p><h3>Understanding the Estimate</h3><ul><li><strong>Materials:</strong> Asphalt shingles are most common ($3-5/sq ft), while Metal lasts longer ($8-14/sq ft).</li><li><strong>Pitch Multiplier:</strong> Steeper roofs (9/12+) cost more due to safety requirements and difficulty.</li><li><strong>Tear-off:</strong> Removing the old roof adds ~$1-2/sq ft but is recommended for longevity.</li></ul>",
                es: "<h2>Calculadora de Reemplazo de Techo</h2><p>Un techo nuevo es un gasto mayor. Esta herramienta te ayuda a presupuestar materiales y mano de obra.</p><h3>Entendiendo la Estimación</h3><ul><li><strong>Materiales:</strong> Tejas de asfalto son comunes, Metal dura más.</li><li><strong>Inclinación:</strong> Techos empinados cuestan más por seguridad.</li><li><strong>Desmontaje:</strong> Remover el techo viejo añade costo pero mejora la durabilidad.</li></ul>",
                de: "<h2>Dachkosten-Rechner</h2><p>Ein neues Dach ist eine große Investition. Dieses Tool hilft Ihnen bei der Budgetierung von Material, Arbeit und Entsorgung.</p><h3>Die Schätzung verstehen</h3><ul><li><strong>Materialien:</strong> Asphaltschindeln sind günstiger, Metall hält länger.</li><li><strong>Neigung:</strong> Steile Dächer sind aufwendiger und teurer.</li><li><strong>Abriss:</strong> Das Entfernen des alten Dachs erhöht die Kosten, ist aber empfohlen.</li></ul>",
                fr: "<h2>Calculateur de Remplacement de Toiture</h2><p>Une nouvelle toiture est une dépense majeure. Cet outil vous aide à budgétiser matériaux, main-d'œuvre et évacuation.</p><h3>Comprendre l'Estimation</h3><ul><li><strong>Matériaux :</strong> Le bardeaux d'asphalte est courant, le métal dure plus longtemps.</li><li><strong>Pente :</strong> Les toits pentus coûtent plus cher (sécurité).</li><li><strong>Dépose :</strong> Enlever l'ancien toit ajoute un coût mais est recommandé.</li></ul>",
