...
module.exports = {
    mortgage: {
        ...
        config: {
            ...
            fields: [
                { id: "price", type: "number", label: { en: "Home Price", es: "Precio de la Casa", de: "Hauspreis", fr: "Prix du Bien", pt: "Preço do Imóvel", it: "Prezzo Casa", nl: "Huisprijs", pl: "Cena Nieruchomości", sv: "Bostadspris", no: "Boligpris", da: "Boligens Pris", fi: "Asunnon Hinta" }, default: 350000, min: 50000, max: 10000000, step: 5000 },
                { id: "down", type: "number", label: { en: "Down Payment", es: "Pago Inicial", de: "Anzahlung", fr: "Apport", pt: "Entrada", it: "Anticipo", nl: "Aanbetaling", pl: "Wpłata Własna", sv: "Kontantinsats", no: "Egenkapital", da: "Udbetaling", fi: "Ksiraha" }, default: 70000, min: 0, max: 1000000, step: 1000 },
                { id: "rate", type: "number", label: { en: "Interest Rate (%)", es: "Tasa de Interés (%)", de: "Zinssatz (%)", fr: "Taux d'Intérêt (%)", pt: "Taxa de Juros (%)", it: "Tasso Interesse (%)", nl: "Rente (%)", pl: "Oprocentowanie (%)", sv: "Ränta (%)", no: "Rente (%)", da: "Rente (%)", fi: "Korko (%)" }, default: 6.8, min: 0.1, max: 15, step: 0.1 },
                {
            ...
            formula: "((price - down) * (rate/100/12) * Math.pow(1 + rate/100/12, years*12) / (Math.pow(1 + rate/100/12, years*12) - 1)) + (isActive('taxAmount') ? taxAmount/12 : (price * taxRate/100/12)) + (insurance/12) + hoa",
            ...
            breakdown: [
                { label: { en: "Principal & Interest", es: "Capital e Interés", de: "Kapital & Zinsen", fr: "Capital & Intérêts", pt: "Capital & Juros", it: "Capitale & Interessi", nl: "Aflossing & Rente", pl: "Kapitał i Odsetki", sv: "Amortering & Ränta", no: "Avdrag og Renter", da: "Afdrag & Renter", fi: "Lyhennys & Korot" }, formula: "((price - down) * (rate/100/12) * Math.pow(1 + rate/100/12, years*12) / (Math.pow(1 + rate/100/12, years*12) - 1))" },
                ...
                { label: { en: "PMI (Est.)", es: "PMI (Est.)", de: "PMI (Gesch.)", fr: "PMI (Est.)", pt: "PMI (Est.)", it: "PMI (Stima)", nl: "Hypotheekgarantie", pl: "Ubezpieczenie", sv: "Bolåneförsäkring", no: "Boliglånsforsikring", da: "Boliglånsforsikring", fi: "Lainatakaus" }, formula: "(down / price < 0.2) ? (price - down) * 0.005 / 12 : 0", tooltip: { en: "Private Mortgage Insurance is typically required when down payment is less than 20%", es: "El seguro hipotecario privado se requiere cuando el pago inicial es menor al 20%", de: "Private Hypothekenversicherung ist erforderlich wenn Anzahlung unter 20% liegt", fr: "L'assurance hypothécaire privée est requise si l'apport est inférieur à 20%", pt: "O seguro hipotecário privado é exigido quando a entrada é inferior a 20%" } }
            ],
            proFeatures: {
                pdf: true,
            ...
            content: {
                en: "<h2>How to Use This Mortgage Calculator</h2><p>Planning your home purchase begins with understanding your monthly obligations. Our 2026 mortgage calculator helps you estimate principal and interest payments, while also accounting for property taxes, homeowners insurance, and HOA fees.</p><h3>Key Factors in Your Payment</h3><ul><li><strong>Principal & Interest:</strong> The core cost of borrowing.</li><li><strong>Property Tax:</strong> Local taxes often bundled into your monthly payment via escrow.</li><li><strong>Home Insurance:</strong> Protection for your investment, required by most lenders.</li><li><strong>HOA Fees:</strong> Monthly costs for maintained communities.</li></ul>",
    ...
    loan: {
        ...
        config: {
            ...
            locale: { en: "en-US", es: "es-ES", de: "de-DE", fr: "fr-FR", pt: "pt-BR", it: "it-IT", nl: "nl-NL", pl: "pl-PL", sv: "sv-SE", no: "no-NO", da: "da-DK", fi: "fi-FI" },
            fields: [
                { id: "amount", type: "number", label: { en: "Loan Amount", es: "Monto del Préstamo", de: "Kreditbetrag", fr: "Montant du Prêt", pt: "Valor do Empréstimo", it: "Importo Prestito", nl: "Leenbedrag", pl: "Kwota Kredytu", sv: "Lånebelopp", no: "Lånebeløp", da: "Lånebeløb", fi: "Lainasumma" }, default: 15000, min: 1000, max: 1000000, step: 1000 },
                { id: "rate", type: "number", label: { en: "Interest Rate (%)", es: "Tasa de Interés (%)", de: "Effektiver Jahreszins (%)", fr: "Taux Annuel (%)", pt: "Taxa de Juros (%)", it: "Tasso (%)", nl: "Rente (%)", pl: "Oprocentowanie (%)", sv: "Ränta (%)", no: "Rente (%)", da: "Rente (%)", fi: "Korko (%)" }, default: 9.5, min: 0.1, max: 30, step: 0.1 },
                { id: "months", type: "number", label: { en: "Loan Term (Months)", es: "Plazo (Meses)", de: "Laufzeit (Monate)", fr: "Durée (Mois)", pt: "Prazo (Meses)", it: "Durata (Mesi)", nl: "Looptijd (Maanden)", pl: "Okres (Miesiące)", sv: "Löptid (Månader)", no: "Løpetid (Måneder)", da: "Løbetid (Måneder)", fi: "Laina-aika (kk)" }, default: 36, min: 6, max: 120, step: 6 }
            ],
            formula: "amount * (rate/100/12) * Math.pow(1 + rate/100/12, months) / (Math.pow(1 + rate/100/12, months) - 1)",
            ...
            breakdown: [
                { label: { en: "Total Interest", es: "Interés Total", de: "Gesamtzinsen", fr: "Intérêts Totaux", pt: "Juros Totais", it: "Interessi Totali", nl: "Totale Rente", pl: "Całkowite Odsetki", sv: "Total Ränta", no: "Total Rente", da: "Samlede Renter", fi: "Kokonaiskorko" }, formula: "(result * months) - amount" },
    ...
    solar: {
        ...
        config: {
            ...
            content: {
                en: "<h2>Is Solar Power Worth It in 2026?</h2><p>With rising energy costs, switching to solar has never been more attractive. This calculator estimates your potential for 25-year savings based on your current monthly bill and local sunlight availability.</p><h3>Understanding Solar ROI</h3><p>Solar panels typically pay for themselves within 6 to 9 years. After that period, the energy generated is essentially free, leading to massive long-term savings.</p><p><strong>🛡️ No Sales Pitch:</strong> This is an unbiased tool. We don't sell solar panels—we just help you calculate your potential savings.</p>",
