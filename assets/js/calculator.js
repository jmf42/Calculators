...
const UI_TEXT = {
    en: {
        ...
        reset: 'Reset',
        pdf: 'PDF',
        shareTitle: 'Copy link to this calculation',
        linkCopied: 'Link copied!',
        linkCopiedLong: 'Link to this calculation copied!',
        copyLinkPrompt: 'Copy this link:',
        keyMetrics: 'Key Metrics',
        tableItem: 'Item',
        tableValue: 'Value',
        generatedBy: 'Generated by CalcKit',
        estimatedPayment: 'Estimated Payment',
        report: 'Report',
        reportTitle: 'CalcKit Report',
        ...
        result: 'Result',
        metric: 'Metric',
        pdfInitializing: 'PDF generator is initializing. Please wait 2 seconds...',
        configError: 'Calculator configuration error',
        calcError: 'Configuration Error',
        resetToast: 'Reset to defaults'
    },
    es: {
        share: 'Compartir',
        reset: 'Reiniciar',
        pdf: 'PDF',
        shareTitle: 'Copiar enlace de este cálculo',
        linkCopied: '¡Enlace copiado!',
        linkCopiedLong: '¡Enlace de este cálculo copiado!',
        copyLinkPrompt: 'Copia este enlace:',
        keyMetrics: 'Métricas clave',
        tableItem: 'Elemento',
        tableValue: 'Valor',
        generatedBy: 'Generado por CalcKit',
        estimatedPayment: 'Pago estimado',
        report: 'Reporte',
        reportTitle: 'Informe CalcKit',
        ...
        result: 'Resultado',
        metric: 'Métrica',
        pdfInitializing: 'El generador de PDF se está iniciando. Espera 2 segundos...',
        configError: 'Error de configuración de la calculadora',
        calcError: 'Error de configuración',
        resetToast: 'Restablecido a valores predeterminados'
    },
    de: {
        share: 'Teilen',
        reset: 'Zurücksetzen',
        pdf: 'PDF',
        shareTitle: 'Link zu dieser Berechnung kopieren',
        linkCopied: 'Link kopiert!',
        linkCopiedLong: 'Link zu dieser Berechnung kopiert!',
        copyLinkPrompt: 'Diesen Link kopieren:',
        keyMetrics: 'Kennzahlen',
        tableItem: 'Posten',
        tableValue: 'Wert',
        generatedBy: 'Erstellt von CalcKit',
        estimatedPayment: 'Geschätzte Zahlung',
        report: 'Bericht',
        reportTitle: 'CalcKit-Bericht',
        ...
        result: 'Ergebnis',
        metric: 'Kennzahl',
        pdfInitializing: 'PDF-Generator wird initialisiert. Bitte 2 Sekunden warten...',
        configError: 'Konfigurationsfehler des Rechners',
        calcError: 'Konfigurationsfehler',
        resetToast: 'Auf Standardwerte zurückgesetzt'
    },
    fr: {
        share: 'Partager',
        reset: 'Réinitialiser',
        pdf: 'PDF',
        shareTitle: 'Copier le lien de ce calcul',
        linkCopied: 'Lien copié !',
        linkCopiedLong: 'Lien de ce calcul copié !',
        copyLinkPrompt: 'Copiez ce lien :',
        keyMetrics: 'Indicateurs clés',
        tableItem: 'Élément',
        tableValue: 'Valeur',
        generatedBy: 'Généré par CalcKit',
        estimatedPayment: 'Paiement estimé',
        report: 'Rapport',
        reportTitle: 'Rapport CalcKit',
        ...
        result: 'Résultat',
        metric: 'Indicateur',
        pdfInitializing: 'Le générateur PDF s\'initialise. Veuillez patienter 2 secondes...',
        configError: 'Erreur de configuration du calculateur',
        calcError: 'Erreur de configuration',
        resetToast: 'Réinitialisé aux valeurs par défaut'
    },
    pt: {
        share: 'Compartilhar',
        reset: 'Redefinir',
        pdf: 'PDF',
        shareTitle: 'Copiar link deste cálculo',
        linkCopied: 'Link copiado!',
        linkCopiedLong: 'Link deste cálculo copiado!',
        copyLinkPrompt: 'Copie este link:',
        keyMetrics: 'Métricas principais',
        tableItem: 'Item',
        tableValue: 'Valor',
        generatedBy: 'Gerado por CalcKit',
        estimatedPayment: 'Pagamento estimado',
        report: 'Relatório',
        reportTitle: 'Relatório CalcKit',
        ...
        result: 'Resultado',
        metric: 'Métrica',
        pdfInitializing: 'O gerador de PDF está inicializando. Aguarde 2 segundos...',
        configError: 'Erro de configuração da calculadora',
        calcError: 'Erro de configuração',
        resetToast: 'Redefinido para os valores padrão'
    },
    it: {
        share: 'Condividi',
        reset: 'Reimposta',
        pdf: 'PDF',
        shareTitle: 'Copia link di questo calcolo',
        linkCopied: 'Link copiato!',
        linkCopiedLong: 'Link di questo calcolo copiato!',
        copyLinkPrompt: 'Copia questo link:',
        keyMetrics: 'Metriche chiave',
        tableItem: 'Voce',
        tableValue: 'Valore',
        generatedBy: 'Generato da CalcKit',
        estimatedPayment: 'Pagamento stimato',
        report: 'Report',
        reportTitle: 'Report CalcKit',
        ...
        result: 'Risultato',
        metric: 'Metrica',
        pdfInitializing: 'Il generatore PDF si sta inizializzando. Attendi 2 secondi...',
        configError: 'Errore di configurazione del calcolatore',
        calcError: 'Errore di configurazione',
        resetToast: 'Reimpostato ai valori predefiniti'
    },
    nl: {
        share: 'Delen',
        reset: 'Resetten',
        pdf: 'PDF',
        shareTitle: 'Link naar deze berekening kopiëren',
        linkCopied: 'Link gekopieerd!',
        linkCopiedLong: 'Link naar deze berekening gekopieerd!',
        copyLinkPrompt: 'Kopieer deze link:',
        keyMetrics: 'Belangrijkste statistieken',
        tableItem: 'Item',
        tableValue: 'Waarde',
        generatedBy: 'Gegenereerd door CalcKit',
        estimatedPayment: 'Geschatte betaling',
        report: 'Rapport',
        reportTitle: 'CalcKit-rapport',
        generatedLabel: 'Gegenereerd',
        inputParameters: 'Invoerparameters',
        parameter: 'Parameter',
        results: 'Resultaten',
        result: 'Resultaat',
        metric: 'Metriek',
        pdfInitializing: 'PDF-generator wordt gestart. Wacht 2 seconden...',
        configError: 'Configuratiefout van de calculator',
        calcError: 'Configuratiefout',
        resetToast: 'Teruggezet naar standaardwaarden'
    },
    pl: {
        share: 'Udostępnij',
        reset: 'Zresetuj',
        pdf: 'PDF',
        shareTitle: 'Skopiuj link do tego obliczenia',
        linkCopied: 'Link skopiowany!',
        linkCopiedLong: 'Link do tego obliczenia skopiowany!',
        copyLinkPrompt: 'Skopiuj ten link:',
        keyMetrics: 'Kluczowe metryki',
        tableItem: 'Pozycja',
        tableValue: 'Wartość',
        generatedBy: 'Wygenerowano przez CalcKit',
        estimatedPayment: 'Szacowana płatność',
        report: 'Raport',
        reportTitle: 'Raport CalcKit',
        ...
        result: 'Wynik',
        metric: 'Metryka',
        pdfInitializing: 'Generator PDF jest uruchamiany. Poczekaj 2 sekundy...',
        configError: 'Błąd konfiguracji kalkulatora',
        calcError: 'Błąd konfiguracji',
        resetToast: 'Przywrócono wartości domyślne'
    },
    sv: {
        share: 'Dela',
        reset: 'Återställ',
        pdf: 'PDF',
        shareTitle: 'Kopiera länk till denna beräkning',
        linkCopied: 'Länk kopierad!',
        linkCopiedLong: 'Länk till denna beräkning kopierad!',
        copyLinkPrompt: 'Kopiera den här länken:',
        keyMetrics: 'Nyckeltal',
        tableItem: 'Post',
        tableValue: 'Värde',
        generatedBy: 'Genererad av CalcKit',
        estimatedPayment: 'Beräknad betalning',
        report: 'Rapport',
        reportTitle: 'CalcKit-rapport',
        ...
        result: 'Resultat',
        metric: 'Mått',
        pdfInitializing: 'PDF-generatorn startar. Vänta 2 sekunder...',
        configError: 'Konfigurationsfel för kalkylatorn',
        calcError: 'Konfigurationsfel',
        resetToast: 'Återställt till standardvärden'
    },
    no: {
        share: 'Del',
        reset: 'Tilbakestill',
        pdf: 'PDF',
        shareTitle: 'Kopier lenke til denne beregningen',
        linkCopied: 'Lenke kopiert!',
        linkCopiedLong: 'Lenke til denne beregningen kopiert!',
        copyLinkPrompt: 'Kopier denne lenken:',
        keyMetrics: 'Nøkkeltall',
        tableItem: 'Post',
        tableValue: 'Verdi',
        generatedBy: 'Generert av CalcKit',
        estimatedPayment: 'Estimert betaling',
        report: 'Rapport',
        reportTitle: 'CalcKit-rapport',
        generatedLabel: 'Generert',
        inputParameters: 'Inndataparametere',
        parameter: 'Parameter',
        results: 'Resultater',
        result: 'Resultat',
        metric: 'Metrikk',
        pdfInitializing: 'PDF-generatoren starter. Vent 2 sekunder...',
        configError: 'Konfigurasjonsfeil for kalkulatoren',
        calcError: 'Konfigurasjonsfeil',
        resetToast: 'Tilbakestilt til standardverdier'
    },
    da: {
        share: 'Del',
        reset: 'Nulstil',
        pdf: 'PDF',
        shareTitle: 'Kopiér link til denne beregning',
        linkCopied: 'Link kopieret!',
        linkCopiedLong: 'Link til denne beregning kopieret!',
        copyLinkPrompt: 'Kopiér dette link:',
        keyMetrics: 'Nøgletal',
        tableItem: 'Post',
        tableValue: 'Værdi',
        generatedBy: 'Genereret af CalcKit',
        estimatedPayment: 'Estimeret betaling',
        report: 'Rapport',
        reportTitle: 'CalcKit-rapport',
        generatedLabel: 'Genereret',
        inputParameters: 'Indtastningsparametre',
        parameter: 'Parameter',
        results: 'Resultater',
        result: 'Resultat',
        metric: 'Metrik',
        pdfInitializing: 'PDF-generatoren starter. Vent 2 sekunder...',
        configError: 'Konfigurationsfejl for beregneren',
        calcError: 'Konfigurationsfejl',
        resetToast: 'Nulstillet til standardværdier'
    },
    fi: {
        share: 'Jaa',
        reset: 'Nollaa',
        pdf: 'PDF',
        shareTitle: 'Kopioi tämän laskelman linkki',
        linkCopied: 'Linkki kopioitu!',
        linkCopiedLong: 'Tämän laskelman linkki kopioitu!',
        copyLinkPrompt: 'Kopioi tämä linkki:',
        keyMetrics: 'Avainluvut',
        tableItem: 'Kohta',
        tableValue: 'Arvo',
        generatedBy: 'Luotu CalcKitillä',
        estimatedPayment: 'Arvioitu maksu',
        report: 'Raportti',
        reportTitle: 'CalcKit-raportti',
        generatedLabel: 'Luotu',
        inputParameters: 'Syöteparametrit',
        parameter: 'Parametri',
        results: 'Tulokset',
        result: 'Tulos',
        metric: 'Mittari',
        pdfInitializing: 'PDF-generaattori käynnistyy. Odota 2 sekuntia...',
        configError: 'Laskurin määritysvirhe',
        calcError: 'Määritysvirhe',
        resetToast: 'Palautettu oletusarvoihin'
    }
};
...
class CalcKitCalculator extends HTMLElement {
    ...
    getStyles() {
        return `
            ...
            .calc-field-toggle {
                color: ${this.theme === 'dark' ? '#a5b4fc' : '#6366f1'};
            ...
            .calc-field-toggle:hover {
                ...
                color: ${this.theme === 'dark' ? '#e0e7ff' : '#4f46e5'};
            }
            ...
            .field-help {
                ...
                background: ${this.theme === 'dark' ? 'rgba(99, 102, 241, 0.3)' : 'rgba(99, 102, 241, 0.15)'};
                color: ${this.theme === 'dark' ? '#a5b4fc' : '#6366f1'};
                font-size: 11px; font-weight: 700; margin-left: 8px; cursor: pointer;
                transition: all 0.2s ease;
                border: 1px solid ${this.theme === 'dark' ? 'rgba(99, 102, 241, 0.4)' : 'rgba(99, 102, 241, 0.3)'};
            }
            .field-help:hover {
                background: ${this.theme === 'dark' ? 'rgba(99, 102, 241, 0.5)' : 'rgba(99, 102, 241, 0.25)'};
                transform: scale(1.1);
            }
            ...
            .tooltip-popup {
                position: fixed;
                z-index: 10000;
                background: ${this.theme === 'dark' ? 'rgba(15, 23, 42, 0.98)' : 'rgba(255, 255, 255, 0.98)'};
                color: ${this.theme === 'dark' ? '#e2e8f0' : '#374151'};
                padding: 12px 16px;
                border-radius: 12px;
                font-size: 13px;
                line-height: 1.5;
                max-width: 280px;
                box-shadow: 0 10px 40px rgba(0, 0, 0, 0.3), 0 0 0 1px ${this.theme === 'dark' ? 'rgba(99, 102, 241, 0.3)' : 'rgba(99, 102, 241, 0.2)'};
            ...
            .tooltip-popup::before {
                ...
                border-left: 1px solid ${this.theme === 'dark' ? 'rgba(99, 102, 241, 0.3)' : 'rgba(99, 102, 241, 0.2)'};
                border-top: 1px solid ${this.theme === 'dark' ? 'rgba(99, 102, 241, 0.3)' : 'rgba(99, 102, 241, 0.2)'};
            }
            ...
            .notice-item.success { border-color: rgba(16, 185, 129, 0.4); background: rgba(16, 185, 129, 0.12); }
            .notice-item.warning { border-color: rgba(245, 158, 11, 0.4); background: rgba(245, 158, 11, 0.12); }
            .notice-item.error { border-color: rgba(239, 68, 68, 0.4); background: rgba(239, 68, 68, 0.12); }
    ...
    getHTML() {
        if (!this.config.title) return `<div class="calc-error">${this.escapeHTML(this.getUIText('calcError'))}</div>`;
        const fields = this.config.fields || [];
        const fieldsHTML = fields.map(field => this.renderField(field)).join('');
        const shareLabel = this.getUIText('share');
        const resetLabel = this.getUIText('reset');
        const pdfLabel = this.getUIText('pdf');
        const shareTitle = this.getUIText('shareTitle');
        const toastText = this.getUIText('linkCopied');
        const resultLabel = this.config.resultLabel || this.getUIText('estimatedPayment');
        ...
        return `
            <div class="calc-container" role="form">
                ...
                <div class="result-actions">
                     <button class="action-btn share-btn" id="share-btn" title="${this.escapeHTML(shareTitle)}">
    ...
    attachEventListeners() {
        ...
        // Help button tooltips (click/tap to show)
        this.shadowRoot.querySelectorAll('.field-help').forEach(helpBtn => {
            helpBtn.addEventListener('click', (e) => {
                e.preventDefault();
                e.stopPropagation();
                this.showTooltip(helpBtn);
            });
        });

        // Close tooltip when clicking outside
        this.shadowRoot.addEventListener('click', (e) => {
            if (!e.target.classList.contains('field-help')) {
                this.hideTooltip();
            }
        });
    ...
    showTooltip(helpBtn) {
        const tooltip = this.shadowRoot.getElementById('tooltip-popup');
        if (!tooltip) return;

        const helpText = helpBtn.getAttribute('title') || helpBtn.getAttribute('aria-label');
        if (!helpText) return;

        tooltip.textContent = helpText;

        // Position the tooltip near the help button
        const rect = helpBtn.getBoundingClientRect();
        const containerRect = this.shadowRoot.querySelector('.calc-container').getBoundingClientRect();
        ...
        if (parseInt(tooltip.style.left) > maxRight) {
            tooltip.style.left = `${maxRight}px`;
        }
        ...
        this._tooltipTimeout = setTimeout(() => this.hideTooltip(), 4000);
    }
    ...
    shareScenario() {
        ...
        const copiedText = this.getUIText('linkCopiedLong');
        const promptText = this.getUIText('copyLinkPrompt');
        if (navigator.clipboard && navigator.clipboard.writeText) {
            navigator.clipboard.writeText(shareText).then(() => {
                this.showToast(copiedText);
            }).catch(err => {
    ...
    getUIText(key) {
        ...
        return (UI_TEXT[lang] && UI_TEXT[lang][key]) || (UI_TEXT.en && UI_TEXT.en[key]) || '';
    }
    ...
    handleInput(event) {
        ...
        if (rawValue === '' || rawValue === null) {
            ...
            this.values[fieldId] = field.min;
            inputEl.value = field.min;
            const slider = this.shadowRoot.getElementById(`${fieldId}-range`);
            if (slider) slider.value = field.min;
        } else if (field?.max !== undefined && value > field.max) {
            errorMessage = this.getErrorText('maxValue').replace('{max}', this.formatNumber(field.max));
            this.values[fieldId] = field.max;
            inputEl.value = field.max;
            const slider = this.shadowRoot.getElementById(`${fieldId}-range`);
            if (slider) slider.value = field.max;
        } else {
    ...
    async generatePDF() {
        if (!window.jspdf) {
            alert(this.getUIText('pdfInitializing'));
            return;
        }
        ...
        doc.text(this.getUIText('reportTitle'), 14, 20);

        doc.setFontSize(14);
        doc.setTextColor(60);
        doc.text(title, 14, 30);
        doc.setFontSize(10);
        doc.text(`${this.getUIText('generatedLabel')}: ${date} `, 14, 36);

        // Inputs Section
        doc.setFontSize(12);
        doc.setTextColor(0);
        doc.text(this.getUIText('inputParameters'), 14, 50);
        ...
        doc.autoTable({
            startY: 55,
            head: [[this.getUIText('parameter'), this.getUIText('tableValue')]],
            body: inputBody,
            theme: 'grid',
        ...
        doc.setFontSize(12);
        doc.text(this.getUIText('results'), 14, resultY);
        ...
        const resultLabel = this.config.resultLabel || this.getUIText('result');
        ...
        if (this.config.breakdown) {
            ...
            doc.autoTable({
                startY: resultY + 15,
                head: [[this.getUIText('tableItem'), this.getUIText('tableValue')]],
                body: breakdownData,
                theme: 'striped'
            });
        }
        ...
        if (Array.isArray(this.config.metrics) && this.config.metrics.length) {
            ...
            doc.setFontSize(12);
            doc.setTextColor(0);
            doc.text(this.getUIText('keyMetrics'), 14, metricsY);

            doc.autoTable({
                startY: metricsY + 5,
                head: [[this.getUIText('metric'), this.getUIText('tableValue')]],
                body: metricsData,
                theme: 'striped'
            });
        }
        ...
        doc.text(this.getUIText('generatedBy'), 14, 280);

        doc.save(`${title.replace(/ /g, '_')}_${this.getUIText('report')}.pdf`);
    }
    ...
    resetToDefaults() {
        ...
        this.showToast(this.getUIText('resetToast'));
    }
}
